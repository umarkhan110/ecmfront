...
const Navb = () => {
  ...
  const [input, setInput] = useState({
    ...
    return (
        ...
        <Navbar collapseOnSelect expand="lg" variant="dark" className="main1" id="main123" >
          <Container>
            <Navbar.Brand href="/" className='navbarbrand'><img src={logo}></img></Navbar.Brand>

            <div className='main1nav'>
              <div className='main1sign ' onClick={handleShow2}><i><FaSignInAlt /></i>Signin</div>
              <NavLink  exact to="/addhostel" className='main1navbtn'>Add Your Hostel+</NavLink>
            </div>

          </Container>
        </Navbar>

        <Navbar collapseOnSelect expand="lg" variant="dark" className="main1_1" id="main1_123" >
          <Container>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              ...
              <Nav className="navlink">
                ...
                <Nav.Link href="/hostels" id="nav-link">Hostels</Nav.Link>
